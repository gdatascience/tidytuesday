...
**[Download the interactive UMAP map (HTML)](outputs/umap_plotly.html)**
...
**[Download the interactive network graph
(HTML)](outputs/visnetwork.html)** — download and open in your browser
to explore
