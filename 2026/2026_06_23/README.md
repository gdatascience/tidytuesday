...
Beyond static charts, we built two interactive tools for exploring the
relationships between paragraphs across all four encyclicals. Both use
TF-IDF vectors to measure textual similarity â paragraphs with similar
vocabulary land near each other.

### UMAP Semantic Map

[UMAP](https://umap-learn.readthedocs.io/) (Uniform Manifold
Approximation and Projection) reduces each paragraph’s 500-dimensional
TF-IDF vector down to 2D coordinates while preserving local structure.
The result: paragraphs that use similar vocabulary cluster together
spatially, revealing thematic neighborhoods that cross encyclical
boundaries.
...
**[Explore the interactive UMAP
map](https://htmlpreview.github.io/?https://raw.githubusercontent.com/gdatascience/tidytuesday/master/2026/2026_06_23/outputs/umap_plotly.html)**

### Network Graph

The network graph connects paragraphs with edges wherever their cosine
similarity exceeds 0.15. A force-directed layout then pulls connected
nodes together, naturally clustering paragraphs by theme. Click any node
to highlight its connections; use the dropdown to filter by encyclical.
...
graph](https://htmlpreview.github.io/?https://raw.githubusercontent.com/gdatascience/tidytuesday/master/2026/2026_06_23/outputs/visnetwork.html)**
